...
export default {
  ...
  data() {
    return {
      ...
      inputComment: "",
      allTags: [
        { id: 1, color: "primary", checked: false },
        { id: 2, color: "success", checked: false },
        { id: 3, color: "error", checked: false },
        { id: 4, color: "warning", checked: false },
        { id: 5, color: "magenta", checked: false },
        { id: 6, color: "volcano", checked: false },
        { id: 7, color: "orange", checked: false },
        { id: 8, color: "yellow", checked: false },
        { id: 9, color: "purple", checked: false }
      ]
    };
  },
  methods: {
    ...
    saveComment() {
      ...
      this.comments.push({ id: length + 1, content: this.inputComment });
      this.closeComment();
    },
    // close comment-edit
    closeComment() {
