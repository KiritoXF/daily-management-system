<template>
  <Row style="height: 750px;">
    ...
    <CellGroup>
      ...
      <Cell v-for="emp in employees" :key="emp.title" v-show="emp.numbers > 0">{{ emp.title }} : {{ emp.numbers }}
      </Cell>
    </CellGroup>
    </Col>
  </Row>
    ...
    data() {
      return {
        ...
        employees: [{
            ...
            cost: 10,
            income: 1,
            title: "level1 programmer"
          },
          {
            numbers: 0,
            cost: 30,
            income: 5,
            title: "level2 programmer"
          },
          {
            numbers: 0,
            cost: 100,
            income: 10,
            title: "level3 programmer"
          },
          {
            numbers: 0,
            cost: 300,
